        ...
        public PersonalMasterBotConfig CreateMasterBotTemplate()
        {
            PersonalMasterBotConfig config = new PersonalMasterBotConfig()
            {
                Messages = new Dictionary<string, string>()
                {
                    ...
                    ["WAITCINFIRM"] = "Ожидайте подтверждения админа",
                    ["NEWAPP"] = "Человек записался на прием",
                    ["YOURAPPCONFIRM"] = "Ваша запись подтверждена",
                    ["YOURAPPNOTCONFIRM"] = "Ваша запись не подтверждена",
                    ["ADMINCHOISEDAY"] = "Выбирите день",
                    ["WRITEAPPTIME"] = "Напишите время приема",
                    ["ISWEEKENDFORUSER"] = "Этот день - выходной",
                    ["WEEKENDWARNING"] = "Продолжить делать день выходным? имеет не свободные записи",
